...
public class EaseTitleBar extends RelativeLayout{
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        this.setLeftLayoutClickListener(new OnClickListener() {
            @Override
        ...
        this.setRightLayoutVisibility(GONE);
    ...
    private void parseStyle(Context context, AttributeSet attrs){
        if(attrs != null){
            ...
            if (null != rightDrawable) {
                ...
                this.setRightLayoutVisibility(VISIBLE);
            }
    ...
    public void setTitle(int strId) {
        this.setTitle(getResources().getString(strId));
    }
